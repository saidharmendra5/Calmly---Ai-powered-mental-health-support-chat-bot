...
//   // 1. Fetch User Location on Mount (High Accuracy Mode)
//   useEffect(() => {
//     if ("geolocation" in navigator) {
//       const options = {
//         enableHighAccuracy: true, // Forces GPS/High-precision if available
...
//         (position) => {
//           console.log("High accuracy location acquired:", position.coords.accuracy, "meters");
//           setUserLocation({
...
//         },
//         options // <--- Don't forget to pass this options object!
//       );
//     }
//   }, []);
...
//       // If VITE_API_URL is set (Vercel), use it. Otherwise, use localhost (Laptop).
//       const API_BASE = import.meta.env.VITE_API_URL || "http://localhost:5000";

//       // 2. Construct the specific endpoint
//       const endpoint = chatId
//         ? `${API_BASE}/api/chats/${chatId}/message`
//         : `${API_BASE}/api/chats`;
...
//           // Use optional chaining just in case location is null
